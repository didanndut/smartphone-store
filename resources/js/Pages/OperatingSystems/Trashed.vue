...
defineProps({
    trashed_operatingsystems: Object
});
</script>
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="bg-stone-50 border-b transition duration-300 ease-in-out hover:bg-stone-100"
                                                v-if="(trashed_operatingsystems.length > 0)"
                                                v-for="trashed_operatingsystems in trashed_operatingsystems"
                                                :key="trashed_operatingsystems.id">
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                    {{ trashed_operatingsystems.id }}
                                                </td>
                                                <td
                                                    class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                    {{ trashed_operatingsystems.name }}
                                                </td>
                                                <td
                                                    class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                    <Link :href="
                                                        route(
                                                            'operatingsystems.restore',
                                                            trashed_operatingsystems.id
                                                        )
                                                    ">
                                                    <PrimaryButton>
                                                    ...
                                                    <Link :href="
    route(
        'operatingsystems.destroy_permanent',
        trashed_operatingsystems.id
    )
                                                    ">
