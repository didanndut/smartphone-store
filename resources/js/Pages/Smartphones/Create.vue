...
const storeData = (operatingsystems, brands, manufacturers) => {
    form.os = os.value ? os.value.id : operatingsystems[0].id;
    form.brand = brand.value ? brand.value.id : brands[0].id;
    form.manufacturer = manufacturer.value ? manufacturer.value.id : manufacturers[0].id;
    form.post(route("smartphones.store"), {
        errorBag: "storeData",
        preserveScroll: true,
        onError: () => {
            if (form.errors.os) {
...
<template>
    <AppLayout title="Smartphone">
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <FormSection @submitted="storeData(operatingsystems, brands, manufacturers)">
                <template #title>Add Smartphone</template>

                <template #description>
                    Add a new smartphone data to database.
                </template>
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <TextInput id="type" ref="typeInput" v-model="form.type" type="text"
