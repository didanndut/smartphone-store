...
<template>
    <div>
        ...
        <div class="min-h-screen bg-stone-400">
            <nav class="bg-stone-100 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('smartphones.index')" :active="route().current('smartphones.index')">
                                    Smartphone
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('operatingsystems.index')" :active="route().current('operatingsystems.index')">
                                    Operating System
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('smartphones.index')" :active="route().current('smartphones.index')">
                            Smartphone
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('operatingsystems.index')" :active="route().current('operatingsystems.index')">
                            Operating System
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-stone-200 shadow">
